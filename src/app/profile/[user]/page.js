  ...
  return (
    <div>
      <header class="px-2 py-4 mt-16 flex flex-col justify-center items-center text-center">
        <img
          class="inline-flex object-cover border-4 border-indigo-600 dark:border-indigo-400 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 dark:shadow-indigo-700/100 bg-indigo-50 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400 h-24 w-24 !h-48 !w-48"
          ...
          alt="Wendell Adriel"
        />
        <h1 class="text-2xl text-gray-500 font-bold mt-2">Johh Doe</h1>
